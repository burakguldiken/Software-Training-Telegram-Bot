...
using SoftwareTraining.EnvironmentManager.Connection;
...
namespace SoftwareTraining.Repository.Dapper.Service
{
    ...
    {
        Connection _connection = Connection.CreateConnectionInstance;
        ...
        public IEnumerable<T> ExecuteCommand<T>(string _Command)
        {
            IEnumerable<T> _TList;
            try
            {
